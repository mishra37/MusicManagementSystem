...
class MusicTester {
  ...
  public void initialiseSong() {
    ...
    song1 = new Song("Numb" ,"Linkin Park", "Alternative rock", 
        "Meteora", "https://open.spotify.com/track/numb");
    song2 = new Song("Paradise","Coldplay","Indie", 
        "Mylo Xyloto", "https://open.spotify.com/track/paradise");
    song3 = new Song("Shadow of the Day" , "Linkin Park" ,"Alternative rock", 
        "Minutes to Midnight", "https://open.spotify.com/track/shadow");
    song4 = new Song("Blackout", "Linkin Park" ,"Dance-pop", 
        "A Thousand Suns", "https://open.spotify.com/track/blackout");
    song5 = new Song("Fix You" ,"Coldplay" , "Rock", 
        "X&Y", "https://open.spotify.com/track/fixYou"); 
    song6 = new Song("Young Dumb & Broke" , "Khalid" ,"R&B" ,
        "American Teen", "https://open.spotify.com/track/YoungDumb&Broke");   
    song7 = new Song("Nothing Else Matters" ,"Metallica","Rock", 
        "Metallica","https://open.spotify.com/track/NothingElseMatters");   
    song8 = new Song("The Unforgiven","Metallica","Metal",
        "Metallica", "https://open.spotify.com/track/TheUnforgiven");
    song9 = new Song("In Between", "Linkin Park", "Hard Rock", 
        "Minutes to Midnight", "https://open.spotify.com/track/InBetween");
